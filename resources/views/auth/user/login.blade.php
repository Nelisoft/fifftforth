...
<main class="main" id="top">
  <div class="container" data-layout="container">
    ...
    <div class="row flex-center min-vh-100 py-6">
     ...
     <img class="me-2" src="{{ $settings && $settings->logo_dark ? asset('public/storage/' . $settings->logo_dark) : asset('assets/img/default-logo.png') }}" alt="" width="200">
          ...
          <div class="card-body p-4 p-sm-5">
            <div class="row flex-between-center mb-3">
              ...
              <div class="col-auto fs-10 text-600">
                ...
                <span><a href="{{ route('user.register') }}">Create an account</a></span>
              </div>
            </div>
            ...
            <form action="{{ route('user.login') }}" method="POST">
              ...
              <div class="mb-3 text-end">
                <a href="{{ route('user.password.request') }}" class="text-decoration-none">Forgot Password?</a>
              </div>
